...
function InfoSlide({ isOpen, onClose }) {
  return (
    <>
      {isOpen && (
        <div
      ...
      <div
        className={`flex flex-col items-center fixed top-0 left-0 h-full w-80 bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 ${
